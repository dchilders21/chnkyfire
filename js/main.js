...
$(document).ready(function () {
    ...
    var settings = {
        toggle: "#open-button", // the selector for the menu toggle, whatever clickable element you want to activate or deactivate the menu. A click listener will be added to this element.
        exit_selector: "#close-button", // the selector for an exit button in the div if needed, when the exit element is clicked the menu will deactivate, suitable for an exit element inside the nav menu or the side bar
    ...
    if (window.$('.navbar').length > 0) {
      window.$(window).on('scroll load resize', () => checkScroll());
    }
